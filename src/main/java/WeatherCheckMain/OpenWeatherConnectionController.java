...
public class OpenWeatherConnectionController {
    ...
    private static String parseJson(String city, String country) throws Exception {
...
// call function from script file
    ...
    public String WeatherData(@PathVariable String city, @PathVariable String country) throws Exception {
        if(country == null){
            country = "US";
        }
        return parseJson(city,country);
    }
